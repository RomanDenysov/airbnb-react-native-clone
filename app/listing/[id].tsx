...
const Page = () => {
	...
	const listing: Listing = (listingsData as any[]).find((item) => item.id === id); // It is a simulated interaction with the server
	...
	const shareListing = async () => {
		try {
			...
			console.log("🚀 ~ file: [id].tsx:32 ~ shareListing ~ err:", err);
		}
	};
